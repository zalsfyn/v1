...
wget -q --no-check-certificate https://raw.githubusercontent.com/zalsfyn/v1/main/core/ssr-core.sh -O /etc/init.d/ssrmu
...
Start_SSR(){
	check_pid
	wget -q -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/zalsfyn/v1/main/core/ssr-core.sh"
...
Install_SSR
systemctl restart ssrmu > /dev/null 2>&1
#wget -q -O /usr/bin/ssr raw.githubusercontent.com/zalsfyn/v1/main/shadowsocks/ssrmu.sh && chmod +x /usr/bin/ssr
