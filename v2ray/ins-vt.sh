...
yell='\e[1;33m'
NC='\e[0m'
curl -sS https://raw.githubusercontent.com/zalsfyn/otw/main/resources/ascii-home
...
wget -q -c "https://raw.githubusercontent.com/zalsfyn/v1/main/core/v2ray-core.sh" && chmod +x v2ray-core.sh && ./v2ray-core.sh >/dev/null 2>&1
rm -f v2ray-core.sh
sleep 1
echo -e "[ ${green}INFO$NC ] Downloading & Installing Trojan-Go"
wget -q -c "https://raw.githubusercontent.com/zalsfyn/v1/main/trojan/ins-trojango.sh" && chmod +x ins-trojango.sh && ./ins-trojango.sh >/dev/null 2>&1
...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/zalsfyn/v1/main/dll/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
